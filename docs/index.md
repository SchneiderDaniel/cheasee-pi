...
|---------|-------------|
| [Installation](installation) | Prerequisites, step-by-step setup, verification |
| [Architecture](architecture) | System design, extensions vs MCP, git worktrees, pipeline |
| [Extensions](extensions) | All 17 extensions, agent definitions, published packages |
| [Skills](skills) | 5 reusable skill definitions |
| [Methodology](methodology) | Kanban pipeline, security, token efficiency, daily use |
| [Prompts](prompts) | 11 prompt templates |
