...
Token-saving agent harness with security guardrails and a Kanban git-oriented sub-agent framework. Docker + Pi AI.

{: .fs-6 .fw-300 }

[Read the full README](https://github.com/SchneiderDaniel/cheasee-pi/blob/main/README.md){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
