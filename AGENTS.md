...
<CRITICAL_OVERRIDES>
- THE MAIN BRANCH IS LOCKED. You are strictly forbidden from committing directly to main. Create branch, push and create PR. Merge only by user. Agent never merge.
</CRITICAL_OVERRIDES>
