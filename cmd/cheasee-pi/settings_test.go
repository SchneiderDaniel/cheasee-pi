...
// TestCheaseeSettings_preservesUnknownAndCaseVariantKeys is the core bug-fix
// assertion: a hand-added key in the user-editable cheasee-settings.json must
// survive the next Save instead of being silently dropped (the old typed-only
// Save). Mirrors TestLoadSettings_preservesUnknownAndCaseVariantKeys for
// .pi/settings.json.
